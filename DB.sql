...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-03-26 12:39:51',NULL),('diagnostics.include_raw','OFF','2025-03-26 12:39:51',NULL),('ps_thread_trx_info.max_length','65535','2025-03-26 12:39:51',NULL),('statement_performance_analyzer.limit','100','2025-03-26 12:39:51',NULL),('statement_performance_analyzer.view',NULL,'2025-03-26 12:39:51',NULL),('statement_truncate_len','64','2025-03-26 12:39:51',NULL);
...
-- Dump completed on 2025-04-03 11:46:56
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
...
--
-- Table structure for table `diet_recipe`
--

DROP TABLE IF EXISTS `diet_recipe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `diet_recipe` (
  `diet` int NOT NULL,
  `recipe` int NOT NULL,
  PRIMARY KEY (`diet`,`recipe`),
  KEY `fk_recipe_3_idx` (`recipe`),
  CONSTRAINT `fk_diet_recipe_to_diet` FOREIGN KEY (`diet`) REFERENCES `diet` (`Id`),
  CONSTRAINT `fk_diet_recipe_to_recipe` FOREIGN KEY (`recipe`) REFERENCES `recipe` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `diet_recipe`
--

LOCK TABLES `diet_recipe` WRITE;
/*!40000 ALTER TABLE `diet_recipe` DISABLE KEYS */;
/*!40000 ALTER TABLE `diet_recipe` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `food` (
  ...
  PRIMARY KEY (`Id`),
  KEY `food_type_idx` (`food_type`),
  CONSTRAINT `fk_food_to_food_type` FOREIGN KEY (`food_type`) REFERENCES `food_type` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `food_allergen` (
  `allergen` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `food` int NOT NULL,
  PRIMARY KEY (`allergen`,`food`),
  KEY `food_idx` (`food`),
  CONSTRAINT `fk_allergen` FOREIGN KEY (`allergen`) REFERENCES `allergen` (`label`),
...
LOCK TABLES `food_allergen` WRITE;
/*!40000 ALTER TABLE `food_allergen` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_allergen` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `food_in` (
  ...
  `nutriScore` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `purchaseDate` date DEFAULT NULL,
  `food` int NOT NULL,
  `storageType` int NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_food_idx` (`food`),
  KEY `fk_storage_type_idx` (`storageType`),
  CONSTRAINT `fk_food_in_to_food` FOREIGN KEY (`food`) REFERENCES `food` (`Id`),
  CONSTRAINT `fk_food_in_to_storage_type` FOREIGN KEY (`storageType`) REFERENCES `storage_type` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `food_in`
--

LOCK TABLES `food_in` WRITE;
/*!40000 ALTER TABLE `food_in` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_in` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `ingredient_amount`
--
...
CREATE TABLE `ingredient_amount` (
  ...
  KEY `fk_food_amount_idx` (`food`),
  CONSTRAINT `fk_ingredient_amount_to_food` FOREIGN KEY (`food`) REFERENCES `food` (`Id`),
  CONSTRAINT `fk_ingredient_amount_to_recipe` FOREIGN KEY (`recipe`) REFERENCES `recipe` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ingredient_amount`
--

LOCK TABLES `ingredient_amount` WRITE;
...
CREATE TABLE `recipe` (
  ...
  `isCold` tinyint NOT NULL,
  `lastDateDone` date DEFAULT NULL,
  `timeToMake` int DEFAULT NULL,
  `type` int NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `type_idx` (`type`),
  CONSTRAINT `fk_recipe_to_recipe_type` FOREIGN KEY (`type`) REFERENCES `recipe_type` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recipe_material` (
  ...
  PRIMARY KEY (`material`,`recipe`),
  KEY `fk_recipe_4_idx` (`recipe`),
  CONSTRAINT `fk_recipe_material_to_material` FOREIGN KEY (`material`) REFERENCES `material` (`Id`),
  CONSTRAINT `fk_recipe_material_to_recipe` FOREIGN KEY (`recipe`) REFERENCES `recipe` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `season_food`
--

DROP TABLE IF EXISTS `season_food`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `season_food` (
  `season` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `food` int NOT NULL,
  PRIMARY KEY (`season`,`food`),
  KEY `fk_food_3_idx` (`food`),
  CONSTRAINT `fk_season_food_to_food` FOREIGN KEY (`food`) REFERENCES `food` (`Id`),
  CONSTRAINT `fk_season_food_to_season` FOREIGN KEY (`season`) REFERENCES `season` (`label`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `season_food`
--

LOCK TABLES `season_food` WRITE;
/*!40000 ALTER TABLE `season_food` DISABLE KEYS */;
/*!40000 ALTER TABLE `season_food` ENABLE KEYS */;
UNLOCK TABLES;
